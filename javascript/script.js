let serachBar = document.getElementById("search-bar");
let searchResults = document.getElementById("search-results");

function addTask() {
  if (serachBar.value === "") {
    alert("Please enter the super hero name");
  }
}

serachBar.addEventListener("input", () => searchHeros(serachBar.value));
